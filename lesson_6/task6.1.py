...
my_message = 'I never need anybody\'s in any way, but now these days are gone,' \
             ' i\'m not so self assured ' \
             '(I never need anybody\'s in any way) (I never need anybody\'s in any way)'
new_message = re.sub(r'[^\w\s]', '', my_message)  # модуль rе для того щоб прибрати розділові знаки
